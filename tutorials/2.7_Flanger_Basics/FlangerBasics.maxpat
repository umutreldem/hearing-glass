...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 50.753296125579027, 251.577199280261993, 181.914893388748169, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 289.800126969814301, 263.087837517261505, 184.0, 68.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1038.606820940971375, 343.160417408943204, 123.78379487991333, 49.0 ],
									"presentation_linecount" : 3,
									"text" : "param feedback @default 0. @min -0.95 @max 0.95"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1049.879607439041138, 204.841370820999146, 126.913895845413208, 49.0 ],
									"presentation_linecount" : 3,
									"text" : "param minDelay @default 0 @min 0 @max 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 999.553790330886841, 127.004637002944946, 147.673470497131348, 35.0 ],
									"presentation_linecount" : 2,
									"text" : "param depth @default 200 @min 10 @max 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 457.69773542881012, 327.024053783416775, 123.78379487991333, 49.0 ],
									"text" : "param feedback @default 0. @min -0.95 @max 0.95"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 23.099873244762421, 230.517743706703186, 121.181822180747986, 49.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 468.970521926879883, 188.705007195472717, 126.913895845413208, 49.0 ],
									"text" : "param minDelay @default 0 @min 0 @max 500"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 418.644704818725586, 110.868273377418518, 147.673470497131348, 35.0 ],
									"text" : "param depth @default 200 @min 10 @max 500"
								}
...
,
					"patching_rect" : [ 246.51654464006424, 211.340745503509879, 68.12121307849884, 22.0 ],
					"text" : "gen~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 246.51654464006424, 424.467136800289154, 45.0, 22.0 ],
					"text" : "limi~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 246.51654464006424, 263.087837517261505, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 528.518399766084485, 343.172663564289508, 150.0, 33.0 ],
					"text" : "From \"Audio Processes\" (David Creasey)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 246.51654464006424, 465.271065652370453, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 528.518399766084485, 58.158219928348956, 638.168180141524317, 280.306509680218142 ],
					"pic" : "/var/folders/93/6km8f78n4cx4xx9n6x7m6j700000gp/T/TemporaryItems/NSIRD_screencaptureui_02TPGW/Screenshot 2023-04-04 at 18.32.02.png"
				}
...
, 			{
				"box" : 				{
					"basictuning" : 440,
					"clipheight" : 37.90303099155426,
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "walking_bass.wav",
								"filename" : "walking_bass.wav",
								"filekind" : "audiofile",
								"id" : "u545011153",
								"loop" : 1,
								"content_state" : 								{
...
, 							{
								"absolutepath" : "drums_loop.aif",
								"filename" : "drums_loop.aif",
								"filekind" : "audiofile",
								"id" : "u453003292",
								"loop" : 1,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 246.51654464006424, 58.28653484582901, 237.740750063109544, 116.709092974662781 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.819791305709032, 70.694867301124532, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.819791305709032, 100.457926976818044, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.944785464453844, 185.874590385097463, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.819791305709032, 129.062091636795003, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 53.819791305709032, 157.22875814451595, 150.0, 22.0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "Screenshot 2023-04-04 at 18.32.02.png",
				"bootpath" : "/private/var/folders/93/6km8f78n4cx4xx9n6x7m6j700000gp/T/TemporaryItems/NSIRD_screencaptureui_02TPGW",
				"patcherrelativepath" : "../../../../../../../../private/var/folders/93/6km8f78n4cx4xx9n6x7m6j700000gp/T/TemporaryItems/NSIRD_screencaptureui_02TPGW",
				"type" : "PNG",
				"implicit" : 1
			}
, 			{
